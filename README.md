...
| [`polyfrac`](https://github.com/nickharris808/polyfrac) ← *you are here* | Exact polynomial and rational-function arithmetic over ℚ with Sturm real-root counting. Zero deps. |
